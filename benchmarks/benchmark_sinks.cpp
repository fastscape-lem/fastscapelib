...
void
benchmark_sinks_flat(xt::xtensor<double, 2>& elevation, xt::xtensor<bool, 2>&)
{
...
void
benchmark_sinks_sloped(xt::xtensor<double, 2>& elevation, xt::xtensor<bool, 2>&)
{
...
void
benchmark_wei2018_flat(xt::xtensor<double, 2>& elevation, xt::xtensor<bool, 2>&)
{
...
// WARNING: the following algorithm does not solve depression with a slight slope, as it would be
// excpected for fastscape.

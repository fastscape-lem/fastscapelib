...
namespace fastscapelib
{
    ...
    template <BasinAlgo algo,
              ...
              class Active_XT,
              class Elevation_XT>
    void correct_flowrouting(BasinGraph_T& basin_graph,
                             Basins_XT& basins,
                             Rcv_XT& receivers,
                             ...
                             typename Elevation_XT::value_type dy)
    {
        ...
        }
        {
            ...
            basin_graph.template update_receivers<algo, connect>(
                receivers, dist2receivers, basins, stack, active_nodes, elevation, dx, dy);
        }
    ...
    void fill_sinks_flat(Water_XT& water,
                         const Elevation_XT& elevation,
    ...
    bool check_fill_flat(const Elevation_XT& elevation,
                         const Water_XT& water,
                         const Active_XT& active_nodes,
                         const Rcv_XT& rcv)
    {
                                     ...
                                     typename Elevation_XT::value_type dy)
    {
...

        {
            ...
            compute_receivers_d8(receivers, dist2receivers, elevation, active_nodes, dx, dy);
            // std::cout << receivers << std::endl;
        }
        ...
        }
        {
            ...
            correct_flowrouting<algo, connect>(basin_graph,
                                               basins,
                                               receivers,
                                               dist2receivers,
                                               ndonors,

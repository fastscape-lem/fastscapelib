...
namespace fastscapelib
{
    ...
    public:
        ...
        virtual const elevation_type& resolve_before_route(const elevation_type& elevation, FG& fgraph) = 0;
        virtual const elevation_type& resolve_after_route(const elevation_type& elevation, FG& fgraph) = 0;

...
def get_version():
    ...
    out = subprocess.check_output(['cmake', '-DINCLUDEDIR=include', '-P', cmake_script],
...
latex_documents = [
    (master_doc, 'fastscapelib.tex', 'fastscapelib Documentation',
     'Benoit Bovy', 'manual'),
]
...
man_pages = [
    (master_doc, 'fastscapelib', 'fastscapelib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fastscapelib', 'fastscapelib Documentation',
     author, 'fastscapelib', 'One line description of project.',
     'Miscellaneous'),
]

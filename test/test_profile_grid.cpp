...
namespace fastscapelib
{
    namespace testing
    {
        ...
        {
            EXPECT_EQ(fs::profile_grid_xt::is_structured(), true);
            EXPECT_EQ(fs::profile_grid_xt::is_uniform(), true);
            EXPECT_EQ(fs::profile_grid_xt::n_neighbors_max(), 2u);
            EXPECT_EQ(fs::profile_grid_xt::container_ndims(), 1);
        }

...
class KernelApplicationOrder:
    ...
    BREADTH_DOWNSTREAM: ClassVar[KernelApplicationOrder] = ...
    BREADTH_UPSTREAM: ClassVar[KernelApplicationOrder] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, value: int) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
class Kernel:
    ...
    @property
    def application_order(self) -> KernelApplicationOrder: ...
    @application_order.setter
    def application_order(self, value: KernelApplicationOrder) -> None: ...
...
class KernelData:
    def __init__(self) -> None: ...
    @property
    def data(self) -> JitClass: ...
    @data.setter
    def data(self, value: JitClass): ...

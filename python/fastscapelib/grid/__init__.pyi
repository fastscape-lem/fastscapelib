...
class HealpixGrid:
    def __init__(
        self, nside: int, node_status: npt.NDArray[np.uint8], radius: float = 6.371e6
    ) -> None: ...
    @property
    def nside(self) -> int: ...
    @property
    ...
    @overload
    def nodes_lonlat(self, idx: int) -> tuple[float, float]: ...
    @overload
    def nodes_lonlat(
        self,
    ) -> tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]]: ...
    @overload
    def nodes_xyz(self, idx: int) -> tuple[float, float, float]: ...
    @overload
    def nodes_xyz(
        self,
    ) -> tuple[
